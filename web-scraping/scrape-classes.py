...
url_max_stats = "https://serenesforest.net/fire-emblem-fates/nohrian-classes/maximum-stats/"
url_mov = "https://serenesforest.net/fire-emblem-fates/nohrian-classes/base-stats/"
url_skills = "https://serenesforest.net/fire-emblem-fates/nohrian-classes/class-skills/"
url_growth_rates = "https://serenesforest.net/fire-emblem-fates/nohrian-classes/growth-rates/"
...
for tr in entries:
    ...
    if class_data:
        if skip is False:
            ...
            # get info for the next next skill if class is Troubadour
            if class_data[3].text.strip() == "Troubadour(M)":
